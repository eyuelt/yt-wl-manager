...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`w-64 sidebar-responsive bg-gray-900 h-screen fixed left-0 top-0 overflow-y-auto border-r border-gray-800 flex flex-col z-40 transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`} style={{ overscrollBehavior: 'contain', paddingLeft: 'env(safe-area-inset-left)' }}>
